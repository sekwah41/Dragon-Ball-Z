package sekwah.mods.dragonballz.player;

import sekwah.mods.dragonballz.animation.DBZAnimator;
import sekwah.mods.dragonballz.playeraccessories.ModelNamek;
import sekwah.mods.dragonballz.playeraccessories.ModeltailModel;
...
public class RenderDBZPlayer extends RenderPlayer {
   ...
   private static final ResourceLocation saiyanTail = new ResourceLocation("dragonballz:textures/accessories/tailModel.png");

    private static final ResourceLocation namekEars = new ResourceLocation("dragonballz:textures/accessories/namekExtras.png");
