package sekwah.mods.dragonballz.blocks.itemrenderers;
...
public class ItemRendererThinTree implements IItemRenderer
{
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(new ResourceLocation("dragonballz:textures/blocks/model/blockThinTree.png"));
